...
#: Synopsis of the TMDB-sourced "Pride" fixture, shared by TV and season payloads.
PRIDE_TV_SYNOPSIS = (
    "Haru Satonaka is the captain of an ice-hockey team, a star athlete who stakes "
    "everything on hockey but can only consider love as a game. Aki Murase is a "
    "woman who has been waiting for her lover who went abroad two years ago. These "
    "two persons start a relationship while frankly admitting to each other that "
    "it is only a love game. …The result is the unfolding of a drama of people "
    "with their respective pasts and with their pride as individuals."
)


@dataclass(frozen=True)
class EpisodeDetails:
    """Optional synopsis and score values for a synthesized episode payload."""
...
_DEFAULT_EPISODE_DETAILS = EpisodeDetails()
...
class YamtrackApiTestCase(APITestCase):
    ...
    def build_episode_metadata(
        ...
        *,
        ...
        title,
        image,
        details=_DEFAULT_EPISODE_DETAILS,
    ):
            ...
            "episodes": [
                {
                    ...
                    "vote_count": details.score_count,
                    "air_date": None,
                    "runtime": None,
                    "episode_type": None,
                    "crew": [],
